...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="{{route('revenue.export',$date)}}" data-bs-toggle="tooltip" title="{{__('Export')}}" class="btn btn-sm btn-primary">
                                ...
                                <tr class="font-style">
                                    ...
                                    <td>
                                        @if(!empty($revenue->add_receipt))
                                            ...
                                            {{-- <a href="{{asset(Storage::url('uploads/revenue')).'/'.$revenue->add_receipt}}" download="" class="action-btn bg-primary ms-2 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="{{__('Download')}}" target="_blank"><span class="btn-inner--icon"><i class="ti ti-download text-white" ></i></span></a> --}}
                                        ...
                                        <td class="Action">
                                            ...
                                            @can('edit revenue')
                                                    <div class="action-btn bg-info ms-2">
                                                           <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('revenue.edit',$revenue->id) }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" data-title="{{ __('Edit Revenue') }}" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
