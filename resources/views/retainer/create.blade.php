...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'retainer','class'=>'w-100')) }}
        <div class="col-12">
                        ...
                        <table class="table mb-0" data-repeater-list="items">
                            ...
                            <tr>
                                <td width="25%" class="form-group pt-0 flex-nowrap">
                                    {{ Form::select('item', $product_services,'', array('class' => 'form-control js-searchBox item'  ,'data-url'=>route('proposal.product'),'required'=>'required')) }}
                                </td>
                                <td>
