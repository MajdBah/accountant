                                ...
                                <tbody>
                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a
                                                    href="<?php echo e(route('report.ledger')); ?>?account=<?php echo e($account->id); ?>"><?php echo e($account->name); ?></a>
                                            </td>
                                            <td><?php echo e(!empty($account->subType) ? $account->subType->name : '-'); ?></td>
                                            <td><?php echo e(!empty($account->parentAccount) ? $account->parentAccount->name : '-'); ?>
                                            ...
                                            <td>
                                                <?php if($account->is_enabled == 1): ?>
                                                    <span
                                                        class="badge bg-success p-2 px-3 rounded"><?php echo e(__('Enabled')); ?></span>
                                                <?php else: ?>
                                                    <span
                                            ...
                                            <td class="Action">
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="<?php echo e(route('report.ledger')); ?>?account=<?php echo e($account->id); ?>"
                                                        class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip"
                                                        title="<?php echo e(__('Transaction Summary')); ?>"
                                                        data-original-title="<?php echo e(__('Ledger Summary')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/chartOfAccount/index.blade.php ENDPATH**/ ?>