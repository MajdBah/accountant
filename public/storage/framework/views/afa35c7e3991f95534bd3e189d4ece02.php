...
<head>
    ...
    <link rel="stylesheet" href=" <?php echo e(asset('Resources/assets/fonts/feather.css')); ?>" />
    ...
    <link rel="stylesheet" href=" <?php echo e(asset('assets/css/landing-page.css')); ?>" />
            ...
            <nav class="navbar navbar-expand-md  default top-nav-collapse">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav">
                        ...
                        <?php if(isset($settings['is_feature_cards_on']) &&  $settings['is_feature_cards_on'] == 'on'): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#features"><?php echo e($settings['feature_title']); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(isset($settings['is_pricing_plan_section_on']) &&  $settings['is_pricing_plan_section_on'] == 'on'): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#plan"><?php echo e($settings['plan_title']); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(isset($settings['is_faq_section_on']) &&  $settings['is_faq_section_on'] == 'on'): ?>
                            <li class="nav-item">
                                    ...
                                    <div class="card bg-dark shadow-none mb-0">
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex  align-items-center ">
                                                <?php if(!empty($value->testimonials_user_avtar)): ?>
...
<footer class="site-footer bg-gray-100">
    ...
    <div class="border-top border-dark text-center p-2">
        ...
        <p class="mb-0">
            <?php echo e(__('©')); ?> <?php echo e(date('Y')); ?>
...
<script src="<?php echo e(asset('Modules/LandingPage/Resources/assets/js/plugins/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('Modules/LandingPage/Resources/assets/js/plugins/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('Modules/LandingPage/Resources/assets/js/plugins/feather.min.js')); ?>"></script>
...
<?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>