                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h4 class="mb-0 text-primary">
                                                <?php echo e(\Auth::user()->priceFormat(\Auth::user()->todayIncome())); ?></h4>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h4 class="mb-0 text-info">
                                                <?php echo e(\Auth::user()->priceFormat(\Auth::user()->todayExpense())); ?></h4>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h4 class="mb-0 text-warning">
                                                <?php echo e(\Auth::user()->priceFormat(\Auth::user()->incomeCurrentMonth())); ?></h4>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h4 class="mb-0 text-danger">
                                                <?php echo e(\Auth::user()->priceFormat(\Auth::user()->expenseCurrentMonth())); ?></h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($bill->status == 0): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-secondary"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                    <?php elseif($bill->status == 1): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-warning"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                    <?php elseif($bill->status == 2): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-danger"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                    <?php elseif($bill->status == 3): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-info"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                    <?php elseif($bill->status == 4): ?>
                                                        <span
                                                            class="p-2 px-3 fix_badge rounded badge bg-success"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        ...
                                        <table class="table align-items-center mb-0 ">
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h4 class="text-muted">
                                                            <?php echo e(\Auth::user()->priceFormat($weeklyBill['billPaid'])); ?></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <h4 class="text-muted">
                                                            <?php echo e(\Auth::user()->priceFormat($weeklyBill['billDue'])); ?></h4>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table align-items-center mb-0 ">
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h4 class="text-muted">
                                                            <?php echo e(\Auth::user()->priceFormat($monthlyBill['billDue'])); ?></h4>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                    ...
                                                    <span class="row align-items-center mt-3">
                                                        ...
                                                        <span class="col">
                                                            ...
                                                            <h6 class="mb-3 mb-sm-0">
                                                                <?php echo e(__(\App\Models\Goal::$goalType[$goal->type])); ?></h6>
                                                        </span>
                                                        <span class="col">
                                                            <span class="text-muted text-sm"><?php echo e(__('Duration')); ?></span>
                                                            <h6 class="mb-3 mb-sm-0"><?php echo e($goal->from . ' To ' . $goal->to); ?>
                                                        ...
                                                        <span class="col">
                                                            ...
                                                            <h6 class="mb-3 mb-sm-0">
                                                                <?php echo e(number_format($goal->target($goal->type, $goal->from, $goal->to, $goal->amount)['percentage'], Utility::getValByName('decimal_number'), '.', '')); ?>%
                                                            </h6>
                                                            <div class="progress mb-0">
                                                                <div class="progress-bar bg-primary"
                                                                    style="width: <?php echo e(number_format($goal->target($goal->type, $goal->from, $goal->to, $goal->amount)['percentage'], Utility::getValByName('decimal_number'), '.', '')); ?>%">
                                                                </div>
                                                            </div>
                                                        </span>
                                                    </span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/dashboard/index.blade.php ENDPATH**/ ?>