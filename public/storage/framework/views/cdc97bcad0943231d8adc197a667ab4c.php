    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="choose-file form-group">
                ...
                <img id="image" class="mt-2" src="<?php echo e(asset(Storage::url('uploads/defualt/defualt.png'))); ?>" style="width:25%;"/>
            </div>
        </div>
    </div>
</div>
...
</script><?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/revenue/create.blade.php ENDPATH**/ ?>