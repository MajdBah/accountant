...
<?php $__env->startSection('action-btn'); ?>
    ...
    <?php if(\Auth::user()->can('create contract')): ?>
        <div class="float-end">
            <a href="#" data-url="<?php echo e(route('contract.create')); ?>" data-bs-toggle="tooltip" data-size="lg" title="<?php echo e(__('Create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Contract')); ?>" class="btn btn-sm btn-primary position">
            ...
            <div class="card-header card-body table-border-style">
                ...
                <div class="table-responsive">
                    <table class="table datatable">
                        <thead>
                            <tr>
                                <?php if(\Auth::user()->can('show contract')): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/contract/index.blade.php ENDPATH**/ ?>