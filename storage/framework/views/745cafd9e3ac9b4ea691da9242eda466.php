                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <?php echo e(Form::label('type', __('Type'), ['class' => 'text-type'])); ?>
                                            ...
                                            <?php echo e(Form::select('type',$types,isset($_GET['type'])?$_GET['type']:'', array('class' => 'form-control'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/report/statement_report.blade.php ENDPATH**/ ?>