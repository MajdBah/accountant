                                    ...
                                    <tr class="cust_tr" id="vend_detail">
                                        ...
                                        <td class="Action">
                                            <span>
                                                ...
                                                <?php else: ?>
                                                <?php if($Vender->is_enable_login == 0 && $Vender->password == null): ?>
                                                        <div class="action-btn bg-primary ms-2">
                                                            <a href="#"
                                                                class="mx-3 btn btn-sm  align-items-center login_enable"
                                                                data-url="<?php echo e(route('vender.reset', \Crypt::encrypt($Vender['id']))); ?>"
                                                                data-ajax-popup="true" data-size="md"
                                                                data-bs-toggle="tooltip"
                                                                title="<?php echo e(__('Forgot Password')); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/vender/index.blade.php ENDPATH**/ ?>