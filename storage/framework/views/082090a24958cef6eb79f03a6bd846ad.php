                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                ...
                                <?php echo e(Form::label('date', __('Date'), ['class' => 'text-type'])); ?>
                                    ...
                                    <?php echo e(Form::text('date', isset($_GET['date'])?$_GET['date']:null, array('class' => 'form-control month-btn','id'=>'pc-daterangepicker-1', 'placeholder' => 'YYYY-MM-DD'))); ?>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                ...
                                <?php echo e(Form::label('f_account', __('From Account'), ['class' => 'text-type'])); ?>
                                    ...
                                    <?php echo e(Form::select('f_account',$account,isset($_GET['f_account'])?$_GET['f_account']:'', array('class' => 'form-control'))); ?>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                ...
                                <?php echo e(Form::label('t_account', __('To Account'), ['class' => 'text-type'])); ?>
                                    ...
                                    <?php echo e(Form::select('t_account', $account,isset($_GET['t_account'])?$_GET['t_account']:'', array('class' => 'form-control'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/transfer/index.blade.php ENDPATH**/ ?>