                            ...
                            <table class="no-space">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <?php echo e(Utility::dateFormat($settings, $invoice->due_date)); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="view-qrcode">
                                                <?php echo DNS2D::getBarcodeHTML(route('pay.invoice', \Crypt::encrypt($invoice->id)), 'QRCODE', 2, 2); ?>
            ...
            <table class="add-border invoice-summary" styl  e="margin-top: 30px;">
                <thead style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                    <tr>
                        ...
                        <th><?php echo e(__('Price')); ?> <small><?php echo e(('after tax & discount')); ?></small></th>
                    </tr>
                </thead>
                <tbody>
...
<?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/invoice/templates/template1.blade.php ENDPATH**/ ?>