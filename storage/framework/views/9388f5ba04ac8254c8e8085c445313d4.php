...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="<?php echo e(route('transaction.export')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>"
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-sm-12">
            <div class=" multi-collapse mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['transaction.index'], 'method' => 'get', 'id' => 'transaction_report'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::month('end_month', isset($_GET['end_month']) ? $_GET['end_month'] : date('Y-m', strtotime('-5 month')), ['class' => 'month-btn form-control'])); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('account', $account, isset($_GET['account']) ? $_GET['account'] : '', ['class' => 'form-control select'])); ?>
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto float-end ms-2 mt-4">
                                        ...
                                        <a href="<?php echo e(route('transaction.index')); ?>" class="btn btn-sm btn-danger "
    ...
    <div id="printableArea">
        <div class="row">
            <div class="col">
                <input type="hidden"
                    value="<?php echo e($filter['category'] . ' ' . __('Category') . ' ' . __('Transaction') . ' ' . 'Report of' . ' ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange']); ?>"
                    id="filename">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/majd/Desktop/accountants/resources/views/transaction/index.blade.php ENDPATH**/ ?>