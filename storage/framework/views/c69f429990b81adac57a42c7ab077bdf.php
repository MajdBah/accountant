                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <?php echo e(Utility::retainerNumberFormat($settings, $retainer->retainer_id)); ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo e(__('Issue Date')); ?>:</td>
                                        <td class="text-right">
                                            <?php echo e(Utility::dateFormat($settings, $retainer->issue_date)); ?></td>
                                    </tr>

                                    <tr>
                                        <td><?php echo e(__('Due Date')); ?>:</td>
                                        <td class="text-right">
                                            <?php echo e(Utility::dateFormat($settings, $retainer->due_date)); ?></td>
                                    </tr>
                                    <?php if(!empty($customFields) && count($retainer->customField) > 0): ?>
                                        <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($field->name); ?> :</td>
                                                <td> <?php echo e(!empty($retainer->customField) ? $retainer->customField[$field->id] : '-'); ?>

                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                    <?php if($settings['retainer_qr_display'] == 'on'): ?>
                                    <tr>
                                        <td colspan="2">
                    ...
                    <tr>
                        <td>
                            ...
                            <p>
                                ...
                                <?php echo e(!empty($customer->billing_city)?$customer->billing_city:'' .', '); ?>, <?php echo e(!empty($customer->billing_state)?$customer->billing_state:'',', '); ?> <?php echo e(!empty($customer->billing_zip)?$customer->billing_zip:''); ?><br>
                        ...
                        <?php if($settings['shipping_display'] == 'on'): ?>
                            <td class="text-right">
                                ...
                                <p>
                                    ...
                                    <?php echo e(!empty($customer->shipping_city)?$customer->shipping_city:'' . ', '); ?>, <?php echo e(!empty($customer->shipping_state)?$customer->shipping_state:'' .', '); ?> <?php echo e(!empty($customer->shipping_zip)?$customer->shipping_zip:''); ?><br>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td><?php echo e(__('Total')); ?>:</td>
                                    <td><?php echo e(Utility::priceFormat($settings, $retainer->getSubTotal() - $retainer->getTotalDiscount() + $retainer->getTotalTax())); ?>
...
<?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/retainer/templates/template1.blade.php ENDPATH**/ ?>