...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="<?php echo e(route('revenue.export',$date)); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>" class="btn btn-sm btn-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="col col-lg-3 col-md-6 col-sm-12 col-12 ">
                                <div class="btn-box m-2">
                                    <?php echo e(Form::text('date', isset($_GET['date'])?$_GET['date']:date('Y-m-d'), array('class' => 'month-btn form-control pc-datepicker-1','id'=>'pc-daterangepicker-1','placeholder'=>'YYYY-MM-DD'))); ?>
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit revenue')): ?>
                                                    <div class="action-btn bg-info ms-2">
                                                           <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="<?php echo e(route('revenue.edit',$revenue->id)); ?>" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" data-title="<?php echo e(__('Edit Revenue')); ?>" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/13a/1/1d6570cbc2/accountants/resources/views/revenue/index.blade.php ENDPATH**/ ?>